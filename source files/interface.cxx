...
Fl_Button *addKeyframe_button = (Fl_Button *)0;
...
Fl_Window* make_window() {
  Fl_Window* w;
  { Fl_Window* o = main_window = new Fl_Window(741, 640, "Acclaim file player");
    w = o;
    { Fl_Group* o = new Fl_Group(10, 485, 615, 140);
...
#endif
      { Fl_Button* o = exit_button = new Fl_Button(535, 545, 100, 25, "Exit");
        o->labelsize(18);
      ...
      { Fl_Button* o = loadMotion_button = new Fl_Button(315, 495, 100, 25, "Load Motion");
        o->callback((Fl_Callback*)load_callback);
      }
	  { Fl_Button* o = addKeyframe_button = new Fl_Button(425, 495, 100, 25, "Add Keyframe");
		o->callback((Fl_Callback*)addKeyframe_callback);
	  }
	   { Fl_Button* o = reset_button = new Fl_Button(535, 495, 100, 25, "Clear");
		o->callback((Fl_Callback*)reset_callback);
	  }
      { Fl_Button* o = loadActor_button = new Fl_Button(315, 545, 100, 25, "Load Actor");
        o->callback((Fl_Callback*)load_callback);
      }
      { Fl_Button* o = interpolate_button = new Fl_Button(425, 545, 100, 25, "Interpolate");
		o->callback((Fl_Callback*)interpolate_callback);
      }
      { Fl_Button* o = locate_button = new Fl_Button(425, 590, 100, 25, "Locate");
